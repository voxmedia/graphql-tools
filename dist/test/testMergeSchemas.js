                                ...
                                resolvers: {
                                    ...
                                    Booking: {
                                        property: {
                                            ...
                                            resolve: function (parent, args, context, info) {
                                                return info.mergeInfo.delegate('query', 'propertyById', {
                                    ...
                                    Query: {
                                        delegateInterfaceTest: function (parent, args, context, info) {
                                            return info.mergeInfo.delegate('query', 'interfaceTest', {
                                                kind: 'ONE',
                                            }, context, info);
                                        },
                                        ...
                                        nodes: function (parent, args, context, info) {
                                            return __awaiter(this, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0: return [4 /*yield*/, info.mergeInfo.delegate('query', 'bookings', {}, context, info)];
                                                        case 1:
                                                            bookings = _a.sent();
                                                            return [4 /*yield*/, info.mergeInfo.delegate('query', 'properties', {}, context, info)];
                                                        case 2:
                                                            properties = _a.sent();
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                LinkResolvers = function (info) { return ({
                                    Booking: {
                                        property: {
                                            fragment: 'fragment BookingFragment on Booking { propertyId }',
                                ...
                                AsyncQuery = function (info) { return ({
                                    Query: {
                                        nodes: function (parent, args, context) {
                                            return __awaiter(this, void 0, void 0, function () {
                                                var bookings, properties;
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
